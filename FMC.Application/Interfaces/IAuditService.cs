...
public interface IAuditService
{
    ...
    Task RecordFinancialEventAsync(string action, Guid entityId, string entityName, decimal amount, string label, string performedBy, string? details = null);
    
    Task<List<FMC.Shared.DTOs.Admin.AuditLogDto>> GetAuthLogsAsync();
    
    Task<List<FMC.Shared.DTOs.Admin.AuditLogDto>> GetRecentLogsAsync(int count = 20, string? category = null);
